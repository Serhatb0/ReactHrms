...
import {fetchEmployer ,employerStatusChangeAsync } from "../../redux/employers/services";

function EmployerConfirmationPage() {
	...
	const filterEmployer = employers.filter(item =>item.staffApproval === null);
	useEffect(() => {
		if(status === 'idle'){
			  ...
			  <div className="table-title">
				<div className="row">
				  <div className="col-sm-6">
					<h2>Onay Bekleyen İş Verenler</h2>
				  </div>
				</div>
			  </div>
...
export default EmployerConfirmationPage
